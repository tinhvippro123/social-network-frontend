...
onMounted(async () => {
  ...
  setTimeout(() => {
    ...
    selectedCategory.value = 'lap-trinh'
  ...
  <div class="mx-auto w-full max-w-[1600px] px-4 sm:px-6 lg:px-8 py-6 flex flex-col gap-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center gap-3">
        <button @click="router.back()" class="w-10 h-10 rounded-xl bg-white dark:bg-surface-800 border border-gray-200 dark:border-surface-700 flex items-center justify-center text-gray-500 hover:text-primary-500 hover:border-primary-500/30 transition-all">
          <ArrowLeft :size="18" />
        </button>
